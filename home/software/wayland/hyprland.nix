  ...
  wayland.windowManager.hyprland = {
    ...
    extraConfig =
      ...
      + ''
        ...
        bind=,code:122,exec,pamixer -d 1
        bind=,code:123,exec,pamixer -i 1
        bind=,code:121,exec,pamixer -t
        bind=,code:256,exec,pamixer --default-source -t
        bind=SHIFT,code:122,exec,pamixer --default-source -d 1
        bind=SHIFT,code:123,exec,pamixer --default-source -i 1
